...
import { Row, Col, Breadcrumb, Table, Button, Popconfirm, Menu } from 'antd'
...
class OperationIndex extends Component {
    ...
    render() {
        ...
        const columns = [{
          ...
          <Popconfirm title={Helper.delete} okText={Helper.yes} cancelText={Helper.no} onConfirm={this.onClickDel.bind(this, record.operation_id)}>
            <a>删除</a>
          </Popconfirm>
        </span>
            )
        ...
        <div className={styles.content}>
          <div className={styles.contentMainLeft}>
            <Menu className={styles.siderMenu} mode="inline" openKeys={this.state.openKeys} selectedKeys={this.state.selectedKeys} onOpenChange={this.onOpenChange.bind(this)} onClick={this.onClick.bind(this)}>
              {
