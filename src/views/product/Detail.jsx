                ...
                <Form horizontal className={styles.contentMain + ' ' + styles.contentMainPaddingTop}>
                    ...
                    </FormItem>
                    {
                        this.state.memberLevelList.map(function (item) {
                            ...
                            return (
                                <FormItem key={item.member_level_id} {...Helper.formItemLayout}
                                          label={item.member_level_name + '价格'}>
                                                    ...
                                                    <div style={{
                                                        ...
                                                        <FormItem>
                                                            {getFieldDecorator(item.attribute_id + '.' + attribute_default_value, {
                                                                ...
                                                                <Checkbox
                                                                    onChange={this.onChangeSku.bind(this, item.attribute_id, attribute_default_value)}>{attribute_default_value}</Checkbox>
                                                            )}
                                                        </FormItem>
                                                    </div>
                                                )
                                        ...
                                        <Col span={18}>
                                            ...
                                            <div className={styles.skuInput}>价格</div>
                                            {
                                                this.state.memberLevelList.map(function (memberLevel) {
                                                    return (
                                                        <div key={memberLevel.member_level_id}
                                                             className={styles.skuInput}>{memberLevel.member_level_name + '价格'}</div>
                                                    )
                                                }.bind(this))
                                            }
