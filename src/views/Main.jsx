...
import { Spin, Row, Col, Button, Menu, Breadcrumb, Icon } from 'antd'
...
class Main extends Component {
    ...
    render() {
        ...
        <Menu className={styles.sidebar} mode="inline" openKeys={this.state.openKeys} selectedKeys={this.state.selectedKeys} onOpenChange={this.onOpenChange.bind(this)} onClick={this.onClick.bind(this)}>
          {
