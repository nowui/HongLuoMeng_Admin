  ...
  render() {
    ...
    return (
      <Modal title="我的图片" width={910} visible={this.state.visible} closable={false} maskClosable={false} onOk={this.onClickOk} onCancel={this.onClickCancel} footer={[
        <Button key="product" type="ghost" size="default" icon="cloud-upload" onClick={this.onClickProduct.bind(this)} style={{float: 'left', marginLeft: 5}}>上传等比例图片</Button>,
        ...
        <Button key="submit" type="primary" size="default" icon="check-circle" onClick={this.onClickOk.bind(this)}>确定</Button>
      ]}>
        <Spin size="large" spinning={this.state.isLoad}>
          {
            ...
            <div style={{minHeight: 570}}>
              ...
              <br/>
              <Button key="submit" type="primary" size="default" icon="check-circle" onClick={this.onClickUpload.bind(this)}>上传</Button>
            </div>
            :
            ''
          }
